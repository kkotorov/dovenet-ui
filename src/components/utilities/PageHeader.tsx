...
export default function PageHeader({ title, actions, right }: PageHeaderProps) {
  return (
    <div className="sticky top-16 z-40 mb-6 flex flex-col md:flex-row items-center justify-between gap-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-md border border-gray-200/60 transition-all">
      {/* Left: title */}
