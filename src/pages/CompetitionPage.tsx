      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCompetitions.map(c => (
          <div
            ...
            className="cursor-pointer bg-white shadow-lg rounded-2xl p-5 hover:shadow-2xl transition relative"
          >
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="flex gap-2">
                <button
                  onClick={e => { e.stopPropagation(); setEditingCompetition(c); setOpenForm(true); }}
            ...
            <div className="flex flex-col gap-2">
              ...
              {c.startLatitude != null && c.startLongitude != null && (
                ...
                >
                  <MapPin className="w-4 h-4" /> {c.startLatitude.toFixed(2)}, {c.startLongitude.toFixed(2)}
                </button>
              )}
              ...
              {c.notes && (
                <p className="mt-3 text-sm text-gray-600 italic">{c.notes}</p>
              )}
            </div>
          </div>
        ))}
